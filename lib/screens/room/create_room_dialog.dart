                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        response = await NetworkHelper.createRoom(userDetails);
                        print(response);
                        DialogManager.hideDialog(context);
                        DialogManager.hideDialog(context);
                        if(response['success']){
                          DialogManager.showCustomDialog(context, ConfirmationRoom(name: response['result']['name'], id:response['result']['id']), true);
                        }
                        else{
                          //error dialog
                        }
